...
Plugin URI: http://ambitionally.com/
Donate link: http://ambitionally.com/
Tags: popups, free popups, lightbox, conversion, sign-up form, popup, exit-intent, aweber, email, full page popup, full screen pop, full screen popup, infusionsoft, madmimi, mailchimp, optin, optin popup,pop-up, popup, popup box, popup message, popup window, popups, unblockable, wordpress popup, ontraport, activecampaign, active campaign, after post optin form, after post optin form plugin, campaign monitor, constant contact, emma, getresponse, icontact, lead gen, lead generation, lead generation wordpress, lightbox, lightbox optins, lightbox popup, lightbox popup plugin, lightbox popups, mailerlite, mailpoet, mobile optin forms, mobile optins, mobile popup, mobile popups, responsive popup, responsive optin, mobile friendly popup, mobile friend optin, optin form, optin forms, pop over, popup plugin, sidebar form, sidebar optin, sidebar optin form, wordpress after post optin form, wordpress lead gen, wordpress lead generation, wordpress lightbox optin, wordpress lightbox optin form, wordpress lightbox optins, wordpress mobile optin forms, wordpress mobile popup, wordpress mobile popups, wordpress optin form, wordpress overlay popup, wordpress popup, wordpress popup form, wordpress popup plugin, wordpress popup solution, wordpress popups, horizontal optin
...
Exit-intent popups allow you to capture lost visitors and have been shown to increase conversion by over 300%. [PopupAlly](http://ambitionally.com/popupally-pro) allows you to create advanced popup signup forms in under 5 minutes, even if you don't know code. PopupAlly's visual editor allows you to customize the look-and-feel of your popups with an instant preview, saving you lots of time.

Beyond popups, with PopupAlly you can also design an optin box that's embedded anywhere on your site like in your sidebar, below your blog posts, or under your header as a horizontal opt-in.

> **Premium Support**
> The AmbitionAlly&reg; Team does not monitor the WordPress.org forums for the free popup plugin, but you'll find our [extensive tutorials](http://ambitionally.com/popupally/tutorials) will help you get started fast!
>
> Hands-on concierge email support is available to [PopupAlly Pro plugin](http://ambitionally.com/popupally-pro?utm_source=wordpressdirectory&utm_medium=banner&utm_content=main&utm_campaign=popupallypro) customers.
>
> [Click here](http://ambitionally.com/upgrading-to-popupally-pro/?utm_source=wordpressdirectory&utm_medium=banner&utm_content=main&utm_campaign=popupallypro) to see why we created the [premium version](http://ambitionally.com/upgrading-to-popupally-pro/?utm_source=wordpressdirectory&utm_medium=banner&utm_content=main&utm_campaign=popupallypro) with all of the extra feature requests we received! It's even more intuitive and quick to design beautifully customized popups and multiple types of embedded opt-ins, too. It's well worth your investment!

= How PopupAlly Can Help You Build Your List Faster =

Let's take a look at the different features that make PopupAlly worth adding to your site... and the many ways that this free popup and optin box plugin can help you build a strong subscriber base.

= Mobile Friendly Popups and Opt-in Forms =

PopupAlly and PopupAlly Pro are both mobile responsive, which means that you don't have to worry about bad user experience for those on tablets or mobile phones. With PopupAlly, each template comes in 3 sizes that are easily tweaked to look good on smaller screens.

With [PopupAlly Pro](http://ambitionally.com/popupally-pro?utm_source=wordpressdirectory&utm_medium=banner&utm_content=main&utm_campaign=popupallypro), you can add an unlimited number of screen sizes, so if you wanted to show a totally different opt-in form or popup on a different device - you could do that!

= Horizontal Opt-In Forms =

Ever wanted to have a horizontal optin form across the top, bottom, or below the navigation section on your WordPress website? Now you can! With PopupAlly you can use the horizontal optin box template and have people joining your list without taking up a ton of real estate on your site.

Plus, PopupAlly is compatible with any theme - so it will look good and fit with your existing set up.
...
> **Why PopupAlly Should Be The Popup Plugin You Choose**
> "PopupAlly should be THE popup that people install. It's so much nicer and less intrusive than all of the other popups I've seen... even on big name sites. They should totally have PopupAlly instead of the one they have!" - Davina Fear
...
You can create mini-surveys, have unlimited opt-ins, more polite popups, and much more. [Click here to find out why you should consider the upgrade](http://ambitionally.com/upgrading-to-popupally-pro/?utm_source=wordpressdirectory&utm_medium=banner&utm_content=main&utm_campaign=popupallypro). Here's a sneak peek at what new functionality you can expect when you upgrade:

* Intuitive Design Editor For Fully Customized Optin Forms
* Create Popups Of Any Shape (Circles, Transparent, You Name It!)
...
* Reader Decision Points & "Yes Or No" Mini-Survey Popups
...
* Bonus Marketing and List Building Training
* Step-by-Step Video Tutorials, with One-on-One Email Technical Support

= PopupAlly Free WordPess Popup Plugin Is Compatible With All Major Email Marketing Providers =
PopupAlly is extremely flexible and integrates all of the major email marketing platforms, including and not limited to:

MailChimp, AWeber, ConvertKit, Infusionsoft, Ontraport, ActiveCampaign, GetResponse, ConstantContact, CampaignMonitor, TotalSend, Emma, iContact, MailerLite, MadMimi, MailPoet, FeedBlitz, and any other email marketing systems that provides HTML opt-in code!
...
> **What Our Customers Love About PopupAlly Pro**
...
= Check Out Our PopupAlly Step by Step Tutorials =
...
At AmbitionAlly&reg;, we're proud to create intuitive software for ambitious business owners like you. You can get in touch with us through our [contact page](http://ambitionally.com/contact), find out about [our other WordPress plugins](http://ambitionally.com/products), and read our latest articles on [digital marketing](http://ambitionally.com/blog) here.

* [WebinarAlly: the easy WordPress webinar plugin](http://ambitionally.com/webinarally)
* [ProgressAlly: the gamification plugin that adds quizzes, checklists, and social sharing to your membership sites](http://ambitionally.com/progressally)
* [AccessAlly: the only "two-way street integration" membership plugin for ActiveCampaign, Infusionsoft, and Ontraport](http://ambitionally.com/accessally)

Download [AmbitionAlly&reg;](http://ambitionally.com)'s free WordPress popup plugin and increase your optin subscriber rate today! 
...
> 
> Over 30,000 rebellious list builders have gone through the free challenge, and results range from adding a 100 to 1000 new subscribers... to doubling or tripling their email list. [What goal will you set](http://30daylistbuildingchallenge.com)?

== Installation ==

1. Activate the PopupAlly plugin
2. Customize the plugin settings to make your popup and opt-in forms match your website
3. Follow the rest of the [step-by-step tutorials here](http://ambitionally.com/popupally/tutorials/)
4. Make sure to integrate PopupAlly with an email marketing system so you do not lose any subscribers! Don't have an email marketing service yet? Check out [ConvertKit](http://ambitionally.com/aaconvertkit), [ActiveCamapaign](ambitionally.com/active-campaign), or [MailChimp](http://nathalielussier.com/mailchimp). Not sure which of these to choose from? Check out our [best email marketing software comparison review](http://ambitionally.com/generate-more-leads/email-marketing/best-email-marketing-software-for-small-business/).
...
= 2.0.0 =
* Major upgrade to the backend interface.
* Add mobile responsive customization to the popups.
* Improve load performance by storing styling information in a file.
